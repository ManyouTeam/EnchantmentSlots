...
* [📝ItemFormat™ (Simply version)](format/itemformat-tm-simply-version.md)
...
* [⚡Add Lore](general-configs/add-lore.md)
* [🔧Built-in Placeholders](general-configs/built-in-placeholders.md)
...
* [📍Item Placeholder](features/item-placeholder.md)

## 💻Develop

* [API Download](develop/api-download.md)
* [Useful Methods](develop/useful-methods.md)
